...
// EDIT RESULT
    ...
    return (ListSearch(g->l[v], w) != NULL);
}
...
void  insertE(Graph g, Edge e)
{
   ...
   g->edges[e.w][e.v] = 1;
   g->nE++;*/
   if (ListSearch(g->l[e.v], e.w) != NULL) return;
   ListInsert(g->l[e.v], e.w);
   ListInsert(g->l[e.w], e.v);
   g->nE++;
}
...
void  removeE(Graph g, Edge e)
{
   ...
   g->nE--;*/
   if (ListSearch(g->l[e.v], e.w) == NULL) return;
   ListDelete(g->l[e.v], e.w);
   ListDelete(g->l[e.w], e.v);
   g->nE--;
}
